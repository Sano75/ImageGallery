...
public class ImageList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = MainActivity.sqLiteHelper.getData("SELECT * FROM ImageTbl");
        list.clear();
        while (cursor.moveToNext()) {
            try{
                ...
                list.add(new Image(describe, image,id));
            }
            catch (Exception e){
                e.printStackTrace();
                Toast.makeText( this, "Error!!!, Can't handle row in the DB, last row deleted", Toast.LENGTH_SHORT ).show();
               try{ sqLiteHelper.lastRowDelete();} catch(Exception e2){}
            }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = MainActivity.sqLiteHelper.getData("SELECT id FROM ImageTbl");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewFood = (ImageView) dialog.findViewById(R.id.imageViewImage);
        final EditText desrcibe = (EditText) dialog.findViewById(R.id.descEdT);
            ...
            public void onClick(View v) {
                try {
                    MainActivity.sqLiteHelper.updateData(
                            desrcibe.getText().toString().trim(),
